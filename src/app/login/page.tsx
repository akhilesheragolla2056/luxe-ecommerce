        ...
        <div className="min-h-screen flex items-center justify-center -mt-16">
            <div className="glass p-8 rounded-2xl w-full max-w-md shadow-2xl">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-white text-gray-900 border border-gray-300 rounded-lg p-3 hover:bg-gray-50 transition-colors font-medium mb-6"
                >
